...
public class King extends Piece
{
	...
	public boolean move(int row, int column)
	{
		...
		{
			Piece castleRook = this.board.pieceAt(row, column);
	...
	public boolean moveNormallyLegal(int row, int column)
	{
		...
		{
			if (this.board.pieceAt(row, column) instanceof Rook && 
					((Rook) this.board.pieceAt(row, column)).firstMove)
			{
	...
	public void draw(Graphics2D g2, int size) 
	{
		...
		try
		{
			...
			{
				bimg = ImageIO.read(new File("C:/Users/candy/Desktop/Home Java Stuff/ChessGame-master/files/wking.png"));
			}
			else
			{
				bimg = ImageIO.read(new File("C:/Users/candy/Desktop/Home Java Stuff/ChessGame-master/files/bking.png"));
			}
